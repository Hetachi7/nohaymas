...
<div class="container">
    ...
    <div class="tarjetas">
        ...
        <div class="contenido">
            ...
            <p>Leyenda del sol y su hijo Cerca a la comunidad indígena de YUTICA, que en dialecto se llama ÑA´PIMA, del bajo Vaupés, ubicada en un caño pequeño llamado caño sol, hay una laguna conocida con el nombre de DIADOEDIJTARA.</p>
            <a href="<?php echo e(route('leyenda')); ?>">Leer más</a>
...
<?php /**PATH C:\xampp\htdocs\Magica_colombia\resources\views////Departamentos/tarjetaVaupes.blade.php ENDPATH**/ ?>